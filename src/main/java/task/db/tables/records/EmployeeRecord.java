...
public class EmployeeRecord extends UpdatableRecordImpl<EmployeeRecord> implements Record3<String, String, String> {

    private static final long serialVersionUID = 859739140;
     ...
     */
    @Override
    public EmployeeRecord values(String value1, String value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public EmployeeRecord(String username, String email, String name) {
        super(Employee.EMPLOYEE);
